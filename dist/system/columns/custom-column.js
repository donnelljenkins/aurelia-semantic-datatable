System.register(['aurelia-framework', '../data-table', './column-setup'], function (_export) {
  ...
  var bindable, inject, noView, DataTable, columnSetup, CustomColumn;
  ...
  return {
    ...
    execute: function () {
      CustomColumn = (function () {
        ...
        CustomColumn = inject(DataTable)(CustomColumn) || CustomColumn;
        CustomColumn = noView(CustomColumn) || CustomColumn;
        return CustomColumn;
      })();

      _export('CustomColumn', CustomColumn);
    }
  };
});